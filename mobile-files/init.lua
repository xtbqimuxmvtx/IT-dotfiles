...
vim.opt_global.timeoutlen = 2200
...
vim.keymap.set("ca", "bdd", "bd!")
vim.keymap.set("ca", "qw", "q!")
...
vim.opt.backupdir = "/data/data/com.termux/files/usr/tmp/nvim-backup//"
vim.opt.backup = true
...
--     }
-- }
-- Key mapping for enabling CSV view with border display
...
vim.api.nvim_set_keymap("n", "<leader><leader>", ":Oil<CR>", { noremap = true, silent = true })
vim.keymap.set({ "n", "i", "v" }, "<leader>c", ":ComfyLineNumbers toggle<CR>", { noremap = true, silent = false })
vim.keymap.set({ "n", "i", "v" }, "<C-p>", "<C-c>:<C-p>", { noremap = true })
...
-- back one word
--vim.api.nvim_set_keymap('c', '<Esc>', '<C-B><S-Left>', { noremap = true, silent = true })
-- forward one word
-- vim.api.nvim_set_keymap('c', '<Esc>', '<C-F><S-Right>', { noremap = true, silent = true })
...
vim.opt.guicursor = ""
vim.g.guicursor = ""
vim.opt.guicursor = "c:block"
local vimrc = vim.fn.stdpath("config") .. "/helpc.vim"
