...
vim.keymap.set({ "n", "v" }, "<C-w>j", ":wincmd k<CR>", { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<C-w>k", ":wincmd j<CR>", { noremap = true, silent = true })
vim.o.tabstop = 4
vim.o.shiftwidth = 4
...
--vim.g.loaded.matchit = true
vim.g.loaded_matchit = 1

-- nvim backups
-- from u/lcheylus ( https://www.reddit.com/r/neovim/comments/wlkq0e/neovim_configuration_to_backup_files_with/ )
